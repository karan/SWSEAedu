...
CODES = ['COM', 'CHEM', 'BIOL', 'CHIN', 'DESIGN', 'INFO', 'ENGL', 'CSE', 'ECON', \
         'HIST', 'JSIS', 'MATH', 'MUSIC', 'PHIL', 'PHYS', 'PSYCH', 'SOC', \
         'STAT', 'ARCH', 'ACCTG', 'FIN', 'MKTG', 'EDUC', 'HCDE', 'BIOEN', \
         'AMATH', 'DRAMA', 'ART', 'OPMGT']
